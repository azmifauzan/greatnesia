				...
				<table class="table table-striped table-bordered">
					...
					<tr>
						...
						<td class="action-td2">
							...
							<a title="ajukan kembali" href="<?php echo site_url('artikel/ajukan/'.$ar->artikel_id.'/tolak'); ?>" class="btn btn-small btn-success"><i class="icon-share"></i></a>
							<a title="edit" href="<?php echo site_url('artikel/edit/'.$ar->artikel_id.'/tolak'); ?>" class="btn btn-small"><i class="icon-edit"></i></a>
							<a title="delete" href="<?php echo site_url('artikel/delete/'.$ar->artikel_id.'/tolak'); ?>" class="btn btn-small btn-warning"><i class="icon-remove"></i></a>
						</td>
					</tr>
					<?php endforeach; ?>
					<?php endif; ?>
